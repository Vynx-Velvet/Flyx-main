/**
 * PrimeSrcProvider — movie/tv content provider.
 *
...
import { extractPrimeSrc } from "@flyx/extractors/services";
import { BaseProvider } from "../base";

export class PrimeSrcProvider extends BaseProvider {
  readonly name = "primesrc";
  readonly priority = PROVIDER_PRIORITIES.PRIMESRC;
  ...
  protected async doExtract(request: ExtractionRequest): Promise<{
    ...
    const result = await extractPrimeSrc(request.tmdbId, request.mediaType, request.season, request.episode);
