/**
 * BingeBoxProvider — movie/tv content provider.
 *
...
import { extractBingeBox } from "@flyx/extractors/services";
import { BaseProvider } from "../base";

export class BingeBoxProvider extends BaseProvider {
  readonly name = "bingebox";
  readonly priority = PROVIDER_PRIORITIES.BINGEBOX;
  ...
  protected async doExtract(request: ExtractionRequest): Promise<{
    ...
    const result = await extractBingeBox(request.tmdbId, request.mediaType, request.season, request.episode);
