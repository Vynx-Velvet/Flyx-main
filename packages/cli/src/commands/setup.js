...
// TMDB API v3 keys are 32 hex characters (e.g. 0123456789abcdef0123456789abcdef).
...
async function validateTMDB(key) {
  ...
  if (!looksLikeTMDBKey(key)) {
    return {
      ok: false,
      error: "That doesn't look like a TMDB API key. It should be 32 hex characters (e.g. 0123456789abcdef0123456789abcdef). Get one at https://www.themoviedb.org/settings/api",
    };
  }
  try {
